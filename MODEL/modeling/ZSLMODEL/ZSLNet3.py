...
## i add the bi-direcion attention 
...
class ZSLNet(nn.Module):
    ...
    def attentionModule(self, x,seen_att):
        ...
        parts_map = parts_map_2.reshape(N, 312, W,H)
        ...
        k_1 = parts_map_2.permute(0,2,1) # torch.Size([8, 312, 196])) -> torch.Size([8, 196 ,312]))
        v_1 = parts_map_2  # torch.Size([8, 312, 196]))
        ...
        global_feat = F.avg_pool2d(x4_1, kernel_size=(W, H)).squeeze()
